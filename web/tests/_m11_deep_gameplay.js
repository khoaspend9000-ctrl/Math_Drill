'use strict';
/* M11-I — DEEP REAL-BROWSER GAMEPLAY VERIFICATION.
 *
...
function lessonPlan() {
  // M11: 35 lessons (7 per grade); grade 3 deliberately includes indices above 76.
  return [
    { grade: 1, idx: [0, 1, 5, 9, 15, 25, 30] },
    { grade: 2, idx: [0, 2, 6, 10, 20, 40, 50] },
    { grade: 3, idx: [0, 3, 7, 76, 78, 79, 80] },
    { grade: 4, idx: [1, 4, 8, 12, 30, 50, 60] },
    { grade: 5, idx: [0, 2, 9, 19, 40, 60, 70] }
  ];
}
...
(async function () {
  ...
  console.log('');
  console.log('=== M11 DEEP REAL-BROWSER GAMEPLAY ===');
  ...
  console.log('M11_DEEP_GAMEPLAY: pass=' + (totalFails === 0 ? 1 : 0) + ' fail=' + totalFails);
